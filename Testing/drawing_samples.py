"""
This is just an example file where I can practice drawing.
"""

# Imports the arcade library
import arcade

# Opens a window that is 600 pixels wide and 600 pixels high named "Drawing Example"
...
# Another tree with trunk and ellipse
arcade.draw_rectangle_filled(200, 320, 20, 60, arcade.csscolor.SIENNA)
arcade.draw_ellipse_filled(200, 370, 60, 80, arcade.csscolor.DARK_GREEN)

# Another tree with a trunk and an arc on top
arcade.draw_rectangle_filled(300, 320, 20, 60, arcade.csscolor.SIENNA)
arcade.draw_arc_filled(300, 340, 60, 100, arcade.csscolor.DARK_GREEN, 0, 180)

# Another tree with a trunk and a triangle on top
arcade.draw_rectangle_filled(400, 320, 20, 60, arcade.csscolor.SIENNA)
arcade.draw_triangle_filled(400, 400, 370, 320, 430, 320, arcade.csscolor.DARK_GREEN)

# Another tree with a trunk and a polygon on top
